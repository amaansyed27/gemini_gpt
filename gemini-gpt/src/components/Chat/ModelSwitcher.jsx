...
const MODELS = [
    ...
    { id: 'gemini-3-pro-preview', name: 'Gemini 3 Pro (Preview)', description: 'Next-Gen Reasoning', icon: Sparkles },
    { id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash (Preview)', description: 'Next-Gen Speed', icon: Zap },
